...
nohup ./subspace/target/production/subspace-farmer \
	 ...
	 path=/nvme0n1/subspace,size=3900G \
	 path=/nvme1n1/subspace,size=3900G \
	 path=/nvme2n1/subspace,size=3900G \
	 path=/nvme3n1/subspace,size=3900G \
	 path=/nvme4n1/subspace,size=3900G \
